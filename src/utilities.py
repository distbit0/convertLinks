    ...
    messages = [
        {
            ...
            "content": (
                ...
                "Then add one line prefixed with 'Missed detail: ' (under 25 words) explaining what the reader misses, which fits the above criteria, in as much detail as possible within the word limit, if the reader only reads the bullets and skips reading the full text. Make sure it is useful/accurate and not overly positive or overly critical, to facilitate an informed decision."
                "Then add one line prefixed with 'Why skip: ' (under 25 words) that gives the most compelling yet truthful/accurate explanation/devil's-advocate for why it's not worth reading the rest."
                "Then add one line prefixed with 'Best rebuttal: ' (under 50 words) giving the strongest & most compelling truthful/accurate rebuttal to the article's own stated conclusions/arguments/conclusions, without straw-manning."
