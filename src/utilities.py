    ...
    messages = [
        {
            ...
            "content": (
                ...
                "Then add one line prefixed with '*Best rebuttal:* ' (under 60 words) giving the strongest & most compelling truthful/accurate rebuttal to the article's own stated conclusions/arguments/conclusions, without straw-manning. Ensure rebuttal is not woke, leftist, politically correct, anti-market but rather is accurate, rationalist, technical & insightful/compelling for a technical/rationalist/libertarian researcher/developer/engineer/entrepreneur."
